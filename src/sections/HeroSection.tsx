        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>#1 AI Thumbnail Generator For Youtube </span>
            ...
            >
                Free AI Thumbnail Generator for{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">Youtube</span>
            </motion.h1>
            ...
            >
                <button onClick={()=>navigate('/genrate')} className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11">
                    Genrate now
                </button>
